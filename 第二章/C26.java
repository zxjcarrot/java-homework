class C26 {
	public static void main(String args[]) {
		String s1 = new String("you re a student");
		...
		position = path.lastIndexOf("A.java");// 获取 “A.java”文件的路径。
		System.out.println(path.substring(0, position));// 输出：A.java文件的路径为：”c:\java\jsp”
